...
{\it Operating systems:} Any which supports Mathematica; tested under Debian GNU/Linux 5.0 and Ubuntu Linux 9.04.\\
{\it Programming language used:} Mathematica 7.0\\
{\it Number of bytes in distributed program, including test code and 
documentation: }\\
{\it Distribution format:} tar.gz\\
{\it Nature of Problem:} Analysis of quantum states and quantum channels, 
distance measure for quantum states, quantum partial operations and quantum entropy.\\
{\it Method of Solution:} A Mathematica package is provided implementing parametrization of quantum states and operations, calculation of quantum fidelity and other distance measures and using partial operations. Examples are enclosed in QiExamples.nb Mathematica notebook. \\
