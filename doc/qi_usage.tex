...
\parindent=0pt
\begin{document}
\title{QI Package for \emph{Mathematica} 7.0 (version 0.3.1)}\author{Jaros{\l}aw Miszczak, Piotr Gawron, Zbigniew Pucha{\l}a\\ \small{The Institute of Theoretical and Applied Informatics}\\
...
\textbf{$ H $ }-- Hadamard gate for one qubit. This is predefined constant. See also: QFT.$  $\\
